...
function init() {
  ...
  function gameOver() {
    ...
    if(player.y > height/2 && flag === 0) {
      ...
      tweet.href='http://twitter.com/share?url=https://googledrive.com/host/0B1bi2OexskMzeHBtb3V4SWVrSEE/&text=I just scored ' +score+ ' points in the HTML5 Doodle Jump game!&count=horiztonal&related=GeekLabIN';
    
      var facebook = document.getElementById("fbBtn");
      facebook.href='https://www.facebook.com/dialog/feed?app_id=244165729116514&display=popup&caption=I just scored ' +score+ ' points in the HTML5 Doodle Jump game!  &link=https://googledrive.com/host/0B1bi2OexskMzeHBtb3V4SWVrSEE/&redirect_uri=https://googledrive.com/host/0B1bi2OexskMzeHBtb3V4SWVrSEE/';
